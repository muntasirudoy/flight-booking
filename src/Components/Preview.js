...
import { flighbookdelete } from "../redux/actions/actioncreators";

const Preview = () => {
  const [booking, setBooking] = useState([]);
  const dispatch = useDispatch();
  const bookingInfo = useSelector((state) => state.book.book);
  ...
  const handleDelete = (value) => {
    dispatch(flighbookdelete(value));
  };
  return (
    // <!-- Preview Data -->
